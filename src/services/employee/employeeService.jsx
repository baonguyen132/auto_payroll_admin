...
export const employeeService = {
    ...
    withdrawETH: async (withdrawData) => {
        // withdrawData format: { userCode, privateKey, amount }
    ...
    try {
        ...
        console.log('Service - Transaction logs response:', data);
        return data; // Trả về toàn bộ object { userCode, logs, bookBalance, logCount }
    } catch (error) {
